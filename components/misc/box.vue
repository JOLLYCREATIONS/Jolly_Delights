<template>
    <div class="flex flex-col items-center md:w-48 sm:w-36 w-24 ">
        <div class="rounded-xl md:w-40 md:h-40 sm:w-32 sm:h-32  h-24 w-24 xl:w-40 xl:h-40">
        <img class="rounded-xl md:w-40 md:h-40 sm:w-32 sm:h-32 w-24 h-24  object-cover transition duration-500 ease-in-out transform hover:scale-125" :src="image" />
    </div>
