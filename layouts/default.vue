<template>
    <div class="min-h-screen flex-col w-full tracking-wide font-montserrat">
        <LayoutHeader class="z-40" />
        <main class="grow-1 w-full relative z-20">
            <slot></slot>
        </main>
        <div class="fixed bottom-4 right-4 z-50">
            <button class="rounded-full w-16 h-16 bg-[#CBE7D8] hover:bg-[#ffcf03] border-green-800 border-4 rotate-180"
                @click="scollToTop">
